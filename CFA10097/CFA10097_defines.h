#ifndef __CFA10097_DEFINES_H__
#define __CFA10097_DEFINES_H__
//============================================================================
//
// Definitions specific to the EVE accelerated CFA10097 board.
// (cap-touch) https://www.crystalfontz.com/product/cfaf240400c0030sca11
// (non-touch) https://www.crystalfontz.com/product/cfaf240400e0030tna11
//
...
#define EVE_PEN_UP_BUG_FIX   (1)
//Touch panel defaults to 240x400 -- no calibration needed.
#define EVE_TOUCH_CAL_NEEDED (0)
// DEBUG_NONE (0K flash), DEBUG_STATUS (~1.2K flash) or DEBUG_GEEK (~5.8K flash)
...
#if (0 != TOUCH_DEMO)
#define MANUAL_BACKLIGHT_DEBUG (1)
#endif // (0 != TOUCH_DEMO)
//============================================================================
