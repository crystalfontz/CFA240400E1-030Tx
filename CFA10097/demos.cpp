//============================================================================
//
// Some demo routines for Crystalfontz CFA10097 EVE accelerated displays.
//
...
uint16_t Add_Bitmap_To_Display_List(uint16_t FWol)
  {
  //We have a LCD_WIDTHxLCD_HEIGHT (240x400) tile stored in RAM_G.
...
//for testing Reset_EVE_Coprocessor()
  ...
  if(0==first)
    ...
    //bad
    FWol=EVE_Inflate_to_RAM_G(FWol,
                              CFAM240400xx_030T_ARGB2_LOGO+20,
                              LOGO_SIZE_ARGB2,
                              RAM_G_Unused_Start);
...
uint16_t Add_Logo_To_Display_List(uint16_t FWol)
  ...
  FWol=EVE_Cmd_Dat_0(FWol, EVE_ENC_BITMAP_LAYOUT(ARGB4,Logo_Width*2,Logo_Height));
#endif // 0==LOGO_PNG_0_ARGB2_1

#if 1==LOGO_PNG_0_ARGB2_1
  //EVE_FORMAT_ARGB2 comes in as EVE_FORMAT_ARGB2, 1 byte per pixel
